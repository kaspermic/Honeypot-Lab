...
1. Created an AWS EC2 t3.micro instance running Ubuntu Server 26.04 LTS.
   <img width="1510" height="66" alt="image" src="https://github.com/user-attachments/assets/299c01fd-520b-4dfd-9da3-e5f099f32a9a" />
...
2. Assigned an Elastic IP address to provide a stable public endpoint.
   <img width="1429" height="55" alt="image" src="https://github.com/user-attachments/assets/4c172362-7c43-470b-8e1e-1e287e8f3f14" />
...
3. Connected to the EC2 instance using SSH and verified system configuration with a installed and configured the DShield Honeypot software.
   <img width="677" height="782" alt="image" src="https://github.com/user-attachments/assets/d2d21778-2e2c-40c9-8f47-ef9aa9b1ef06" />
...
5. Verified DShield services were running and listening.
   <img width="619" height="678" alt="image" src="https://github.com/user-attachments/assets/6433085e-4c1d-4c4b-bc85-1024caf35839" />
...
6. Confirmed web honeypot exposure by accessing the public IP from an external network.
...
7. Validated SSH honeypot redirection and service availability.
   <img width="610" height="39" alt="image" src="https://github.com/user-attachments/assets/dc025e5d-1224-4d84-aa6e-bd15c7b73c6f" />
...
8. Monitored honeypot logs and verified collection of real-world scanning activity which confirmed successful operation of the honeypot..
